        ...
        <section className="py-16 px-4 bg-gray-800">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">OECD 8개국 2,480만 건 판례를 실시간 비교 분석합니다</p>
                </div>
                
                <div className="flex justify-center gap-2 mb-8">
                    {caseTypes.map(ct => (
                        <button key={ct.id} onClick={() => setCaseType(ct.id)}
                            className={`px-4 py-2 rounded-lg transition-all ${caseType === ct.id ? 'bg-purple-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}>
                            {ct.name}
                        </button>
                    ))}
                </div>
                    ...
                    <div>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                            {comparison.comparisons.map((c, i) => (
                                <div key={i} className="bg-gray-900 rounded-xl p-4 border border-gray-700 card-hover transition-all">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-yellow-400">{c.win_rate}%</span>
                                        </div>
                                        <div className="flex justify-between">
                        ...
                        <div className="bg-purple-900/30 rounded-xl p-6 border border-purple-500/30">
                            ...
                            <div className="grid md:grid-cols-3 gap-4 text-center">
                                <div className="bg-gray-900 rounded-lg p-4">
                                    ...
                                    <div className="text-sm text-gray-400">총 분석 판례</div>
                                </div>
                                <div className="bg-gray-900 rounded-lg p-4">
                                    <div className="text-3xl font-bold text-yellow-400">8개국</div>
                                    <div className="text-sm text-gray-400">비교 대상국</div>
                                </div>
                                <div className="bg-gray-900 rounded-lg p-4">
                                    <div className="text-3xl font-bold text-green-400">92.4%</div>
                                    <div className="text-sm text-gray-400">AI 정확도</div>
                                </div>
                            </div>
