const AIConsultation = () => {
    ...
    const getUrgencyBg = (level) => {
        const bgs = ['bg-green-900/30 border-green-500/30', 'bg-sky-50 border-blue-500/30', 'bg-yellow-900/30 border-yellow-500/30', 'bg-orange-900/30 border-orange-500/30', 'bg-blue-50 border-red-500/30'];
    ...
    return React.createElement('div', { id: 'ai', className: 'py-16 px-4 bg-gray-50' },
        React.createElement('div', { className: 'max-w-6xl mx-auto' },
            React.createElement('div', { className: 'text-center mb-12' },
                ...
                React.createElement('div', { className: 'mt-4 inline-block px-4 py-2 bg-blue-50 border border-red-500/30 rounded-lg text-sm text-red-300' },
            ...
            React.createElement('div', { className: 'grid lg:grid-cols-2 gap-8' },
                React.createElement('div', { className: 'bg-white rounded-xl p-6' },
                    ...
                    React.createElement('div', { className: 'grid grid-cols-2 gap-4 mb-4' },
                        React.createElement('div', null,
                            ...
                            React.createElement('input', {
                                ...
                                className: 'w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 focus:border-red-500 focus:outline-none'
                            })
                        ),
                        React.createElement('div', null,
                        ...
                        React.createElement('div', { className: 'flex flex-wrap gap-2' },
                            historyOptions.map(item =>
                                React.createElement('button', {
                                    ...
                                    className: `px-3 py-1 rounded-full text-sm transition-all ${medicalHistory.includes(item) ? 'bg-red-600 text-gray-900' : 'bg-gray-100 text-gray-700 hover:bg-gray-600'}`
                                }, item)
                            )
                        )
                    ),
                    ...
                    React.createElement('div', { className: 'mb-4' },
                        ...
                        React.createElement('textarea', {
                            ...
                            rows: 4,
                            className: 'w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 focus:border-red-500 focus:outline-none resize-none'
                        })
                    ),
                ...
                React.createElement('div', { className: 'bg-white rounded-xl p-6' },
                    ...
                    result && React.createElement('div', { className: 'space-y-4' },
                        ...
                        React.createElement('div', { className: 'text-xs text-gray-500 text-center mt-4 p-3 bg-gray-50 rounded-lg' },
                            result.disclaimer
                        )
                    )
                )
