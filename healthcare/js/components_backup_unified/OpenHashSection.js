    ...
    return React.createElement('div', {
        ...
        React.createElement('div', { className: 'max-w-6xl mx-auto' },
            ...
            React.createElement('div', { className: 'grid md:grid-cols-2 gap-6 mb-12' },
                React.createElement('div', { className: 'bg-blue-50 border border-red-500/30 rounded-xl p-6' },
                ...
                React.createElement('div', { className: 'bg-blue-50 border border-blue-500/30 rounded-xl p-6' },
                    React.createElement('h3', { className: 'text-xl font-bold text-blue-600 mb-4' }, '✅ 오픈해시'),
                    React.createElement('ul', { className: 'space-y-3 text-gray-700' },
            ...
            // 4계층 구조 시각화
            React.createElement('div', { className: 'bg-white rounded-xl p-6 mb-8' },
                ...
                React.createElement('div', { className: 'grid grid-cols-4 gap-4' },
                    layers.map((layer, i) =>
                        React.createElement('div', {
                            ...
                            React.createElement('div', { className: 'text-sm text-gray-900' }, layer.name),
                            React.createElement('div', { className: 'text-xs text-gray-600 mt-1' }, layer.desc),
            ...
            React.createElement('div', { className: 'bg-white rounded-xl p-6' },
                React.createElement('div', { className: 'flex justify-between items-center mb-4' },
                    ...
                    React.createElement('button', {
                        ...
                        className: `px-4 py-2 rounded-lg font-semibold transition-all ${isAnimating ? 'bg-gray-600 cursor-not-allowed' : 'bg-teal-600 hover:bg-blue-600'}`
                ...
                isAnimating && React.createElement('div', { className: 'text-center py-8' },
                    ...
                    React.createElement('p', { className: 'text-blue-600' }, 'SHA-256 재해싱 및 계층 선택 중...')
                ),
                
                layerDemo && !isAnimating && React.createElement('div', { className: 'space-y-4' },
                    React.createElement('div', { className: 'bg-gray-50 rounded-lg p-4' },
                        React.createElement('div', { className: 'text-sm text-gray-600 mb-1' }, '원본 해시 (SHA-256)'),
                        React.createElement('div', { className: 'font-mono text-blue-600 text-sm break-all' }, layerDemo.original_hash)
                    ),
                    React.createElement('div', { className: 'grid grid-cols-2 gap-4' },
                        React.createElement('div', { className: 'bg-gray-50 rounded-lg p-4' },
                            React.createElement('div', { className: 'text-sm text-gray-600 mb-1' }, '계층 선택값'),
                            React.createElement('div', { className: 'text-2xl font-bold text-gray-900' }, layerDemo.layer_value)
                        ),
                        React.createElement('div', { className: 'bg-teal-900/50 rounded-lg p-4' },
                            React.createElement('div', { className: 'text-sm text-gray-600 mb-1' }, '선택된 계층'),
                            ...
                            React.createElement('div', { className: 'text-sm text-gray-700' }, layerDemo.selected_layer?.description)
                        )
                    )
                )
            )
